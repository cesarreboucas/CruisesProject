...
class PageAttractions {
  ...
  //Show all the facilities and linked ship names and sailing dates in a table
  ...
  //Show Attractions form (Add and Edit)
  static function showAttractionForm($attraction) {
    ...
    //Get tours to display ship name and sailing date options in the form
    ...
    $tours = ToursMapper::getTours(array());
      ...
      <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
        <div class="field">
          ...
          <div class="control">
            <input class="input" type="text" name="attraction" id="attraction" placeholder="Attraction Name" value="<?php echo $attraction->getAttractionName();?>"/> 
          </div>
        </div>
        <div class="field">
